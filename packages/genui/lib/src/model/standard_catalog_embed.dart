...
class StandardCatalogEmbed {
  /// The JSON content of standard_catalog.json.
  static const String standardCatalogJson = r'''
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://a2ui.dev/specification/v0_9/standard_catalog.json",
  ...
  "functions": [
    {
      ...
      "parameters": {
        "type": "array",
        "items": [{ "$ref": "common_types.json#/$defs/DynamicValue" }],
        "minItems": 1
      }
    },
    {
    ...
    },
    {
      ...
      "parameters": {
        "type": "array",
        "items": [{ "description": "The format string.", "type": "string" }],
        "additionalItems": { "$ref": "common_types.json#/$defs/DynamicValue" },
        "minItems": 1
      }
    },
    {
