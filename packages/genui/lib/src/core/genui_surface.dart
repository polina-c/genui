...
/// [UiDefinition] for the given [surfaceId].
...
class _GenUiSurfaceState extends State<GenUiSurface> {
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder<UiDefinition?>(
      valueListenable: widget.genUiContext.getSurfaceNotifier(widget.surfaceId),
      builder: (context, definition, child) {
        ...
        return _buildWidget(
          ...
          rootId,
          DataContext(
            widget.genUiContext.dataModelForSurface(widget.surfaceId),
            '/',
          ),
        );
      },
  ...
  void _dispatchEvent(UiEvent event) {
    if (event is UserActionEvent && event.name == 'showModal') {
      final UiDefinition? definition = widget.genUiContext
